...
$stmt = $conn->prepare("
    ...
    AND hospital_id NOT IN (
        ...
        UNION
        SELECT hospital_id FROM hospital_enrollment_requests 
...
<body class="bg-gray-50" x-data="{ sidebarOpen: false, showLogoutModal: false }">
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="./patients.php" class="px-3 py-2 rounded-lg <?php echo isActive('patients.php'); ?>">
                        Patients
                    </a>
                </div>
                ...
                <!-- User Menu -->
                <div class="flex items-center space-x-4">
                    <a href="../admin/admin_account_settings.php" class="px-3 py-2 rounded-lg <?php echo isActive('admin_account_settings.php'); ?>">
                        Account Settings
                    </a>
    ...
    <div class="lg:hidden">
        ...
        <!-- Mobile Sidebar -->
        <div x-show="sidebarOpen"
            class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform transition-transform duration-300"
            ...
            <div class="p-4">
                ...
                <nav class="mt-8 space-y-2">
                    ...
                    <a href="./patients.php" class="block px-4 py-2 rounded-lg <?php echo isActive('patients.php'); ?>">
                        Patients
                    </a>
                    <a href="../admin/admin_account_settings.php" class="block px-4 py-2 rounded-lg <?php echo isActive('admin_account_settings.php'); ?>">
                        Account Settings
                    </a>
                    <button @click="showLogoutModal = true; sidebarOpen = false"
                        class="w-full mt-4 px-4 py-2 text-white bg-red-600 hover:bg-red-700 rounded-lg">
                        Logout
                    </button>
                </nav>
            </div>
    ...
    <div class="max-w-7xl mx-auto mt-8 px-4 sm:px-6 lg:px-8 py-8">
        ...
        <?php if ($currentHospital): ?>
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-900 mb-4">Current Hospital</h2>
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                            <div class="p-6">
                                <div class="flex justify-between items-start">
                                    ...
                                    <form action="../../actions/request_enrollments.php" method="POST">
